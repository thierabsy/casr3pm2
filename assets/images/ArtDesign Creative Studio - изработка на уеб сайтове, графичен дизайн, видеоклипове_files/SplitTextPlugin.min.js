        ...
        var b = a.GreenSockGlobals || a,
            ...
            y = function(a, b, c, d, h) {
                ...
                var P, Q, R, S, T, U, V, W, X, Y, Z, $, _, ab, j = e(a),
                    ...
                    N = [],
                    O = [];
                for (I && (J = J.split("++").join("")), K && (j = j.split("<").join("{{LT}}")), P = j.length, S = G(), T = 0; P > T; T++) if (V = j.charAt(T), ")" === V && j.substr(T, 20) === l) S += (L ? F : "") + "<BR/>", L = !1, T !== P - 20 && j.substr(T + 20, 20) !== l && (S += " " + G(), L = !0), T += 19;
                ...
                if (n || r) for (T = 0; P > T; T++) X = W[T], R = X.parentNode === a, (R || r || q && !o) && (Y = X.offsetTop, n && R && Y !== t && "BR" !== X.nodeName && (Q = [], n.push(Q), t = Y), r && (X._x = X.offsetLeft, X._y = Y, X._w = X.offsetWidth, X._h = X.offsetHeight), n && (o !== R && q || (Q.push(X), X._x -= v), R && T && (W[T - 1]._wordEnd = !0), "BR" === X.nodeName && X.nextSibling && "BR" === X.nextSibling.nodeName && n.push([])));
