...
var deleteAction = 'oParentWin.aAction_win3(oParentWin.document.win3' + ',"' + name + '")';psConfirm2("Delete Confirmation", "Delete current/selected rows from this page?  The delete will occur when the transaction is saved.", "OKCancel", " ", deleteAction);}

function DeleteCheck2_win3()
{
...
{
if (obj == null) return;if (typeof gridRowSelRgbColor_win3 != "undefined") {
...
if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2(obj);if(!bTabonly || getLastKey_win3() == "\t".charCodeAt(0))
{
 if(oChange_win3!=null && oChange_win3!=obj)
 {
 oChange_win3.form.ICFocus.value=obj.id; submitAction_win3(oChange_win3.form,oChange_win3.id); oChange_win3 = null; }
...
var val = obj.value;if (val == '') return false;if (val.search(re) != 0)
{
 ...
 PSdeferError_win3(obj, "Number field format error. Please re-enter using the proper format.  %1", fmt); return true;}
return false;}
