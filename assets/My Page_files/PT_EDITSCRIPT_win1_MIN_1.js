...
var oErr_win1 = null;function PSwarning_win1(msg)
{
msg = PSmessageSubst_win1(msg, PSwarning_win1.arguments, 1);if (isFModeLayout()) 
 psConfirmFluid("Warning", msg);else
 psAlert(msg, "Warning");}

function PSdeferWarning_win1(msg)
{
sDefMsg_win1 = PSmessageSubst_win1(msg, PSdeferWarning_win1.arguments, 1);bDefWarning_win1 = true;}

function PSerror_win1(obj, msg)
{
if (bReset_win1)
{
 resetChange(obj); bReset_win1 = false;}
else
{
 obj.PSsaveclass = obj.className; obj.className = "PSERROR";}
msg = PSmessageSubst_win1(msg, PSerror_win1.arguments, 2);if (isFModeLayout()) 
 psConfirmFluid("Error", msg);else
 psAlert(msg, "Error");oErr_win1=obj;}

function PSdeferError_win1(obj, msg)
{
sDefMsg_win1 = PSmessageSubst_win1(msg, PSdeferError_win1.arguments, 2);oDefErr_win1=obj;bDefWarning_win1 = false; }

function PSshowDeferredMsg_win1()
{
if (sDefMsg_win1=="")return;if (bDefWarning_win1)
 PSwarning_win1(sDefMsg_win1);else
 PSerror_win1(oDefErr_win1, sDefMsg_win1);sDefMsg_win1 = "";oDefErr_win1 = null; }

function PSclearError_win1(obj)
{
if (obj == oDefErr_win1)
{
 sDefMsg_win1 = "";  oDefErr_win1 = null; }
}
...
var deleteAction = 'oParentWin.aAction_win1(oParentWin.document.win1' + ',"' + name + '")';psConfirm2("Delete Confirmation", "Delete current/selected rows from this page?  The delete will occur when the transaction is saved.", "OKCancel", " ", deleteAction);}
...
if (arguments.length == 0) 
 ...
 var deleteAction = 'submitAction_win1(document.win1' + ',"' + arguments[0] + '")'; else 
 var deleteAction = 'oParentWin.aAction_win1(oParentWin.document.win1' + ',"' + arguments[0] + '")';     if (isFModeLayout())
...
var oChange_win1 = null;var oDefErr_win1 = null;var sDefMsg_win1 = "";var bDefWarn_win1; var oKillFocus_win1 = null;var oTargetFocus_win1 = null;var bReset_win1 = false;function initVars_win1()
{


oChange_win1 = null;oDefErr_win1 = null;sDefMsg_win1 = "";bDefWarn_win1 = false; oKillFocus_win1 = null;oTargetFocus_win1 = null;bReset_win1 = false;nLastKey_win1 = 0;}
function moveFocus_win1(killobj)
{
if (typeof popupObj_win1 != "undefined" && popupObj_win1 && popupObj_win1.isShown) 
 ptCommonObj2.tryFocus0(popupObj_win1.popupFocus);if (oErr_win1!=null)
{
 oKillFocus_win1 = killobj; oTargetFocus_win1 = oErr_win1; oErr_win1.focus(); oErr_win1 = null;}
}

function doFocus_win1(obj,bTabonly,bDef)
{
if (obj == null) return;if (typeof gridRowSelRgbColor_win1 != "undefined") {
...
if (window.focusHook)
 focusHook(obj);if (obj==oTargetFocus_win1)
{
 oTargetFocus_win1 = null; oKillFocus_win1 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2(obj);if(!bTabonly || getLastKey_win1() == "\t".charCodeAt(0))
{
 if(oChange_win1!=null && oChange_win1!=obj)
 {
 oChange_win1.form.ICFocus.value=obj.id; submitAction_win1(oChange_win1.form,oChange_win1.id); oChange_win1 = null; }
...
{
 oTartgetFocus_win1 = null; oKillFocus_win1 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2();document.win1.ICFocus.value = obj.id;if(oDefErr_win1!=null && oDefErr_win1!=obj)
 PSshowDeferredMsg_win1();moveFocus_win1(obj);}
...
if (typeof obj == "undefined" && typeof id == "undefined") return;if (obj) id = obj.id; else obj = document.getElementById(id);if (!obj || id.length == 0) return;if (isFModeLayout() && obj.type == "select-one")
 ...
 {
 var bFound = false; for (var i = 0; i < document.chgFldArr_win1.length; i++) {
...
gFocusObj=obj;if(sDefMsg_win1!="")
{
 PSshowDeferredMsg_win1(); return false;}


if(oChange_win1 != null)
{
 submitAction_win1(obj.form,obj.id); return true;}
...
var bErr = false; if(sType!='') bErr = checkType_win1(obj, sType, re);if(!bErr && bHist=='Y') bErr = historyUpdated_win1(obj);if(!bErr && bEffdtSub=='Y') bErr =subscrollUpdated_win1(obj);if(!bErr && bDate=='Y') bErr = isReasonableDate_win1(obj);if(!bErr && bYN=='Y') bErr = isYN_win1(obj);if (bErr && bImmed=='Y') PSshowDeferredMsg_win1();return true;}
...
{
if (!isChanged(obj))
 return false;PSdeferError_win1(obj, "Cannot change current or history records unless in Correction mode.");bReset_win1 = true;return true;}

function subscrollUpdated_win1(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win1(obj, "Cannot change key field with effective dated subordinate data unless in Correction mode.");bReset_win1 = true;return true;}
...
if(obj.type == "select-one") obj = obj.options[obj.selectedIndex];var dateval = new Date(obj.value);var now = new Date();var diff = new Date(Math.abs(now.getTime() - dateval.getTime()));if (diff.getMonth > 0)
 ...
 PSdeferWarning_win1("Warning -- date out of range.");return false;}
 ...
 val = obj.value;if (val != 'Y' && val != 'N')
{
 ...
 PSdeferError_win1(obj, "Value must either be Y for Yes or N for No."); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;if (val.search(/^ *\d* *$/) != 0)
{
 ...
 PSdeferError_win1(obj, "Numeric Only field format error.  Please reenter."); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;if (val.search(re) != 0)
{
 ...
 PSdeferError_win1(obj, "Number field format error. Please re-enter using the proper format.  %1", fmt); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;if (!checkTime(val,fmt))
{
 ...
 PSdeferError_win1(obj, "Time field format error.  Please re-enter using the proper format."); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;var newval = checkDateTime(val,fmt);if (newval == "")
{
 ...
 PSdeferError_win1(obj, "Datetime field format error.  Please reenter using the proper format."); return true;}
...
{
 PSdeferError_win1(obj, "The system does not understand the date you entered.");  return true;}
...
{
case 'N': return isNumOnly_win1(obj);case 'S': return isNumeric_win1(obj,sFmt,re);case 'D': return isDate_win1(obj,sFmt);case 'T': return isTime_win1(obj,sFmt);case 'X': return isDateTime_win1(obj,sFmt);}
return false;}
...
var bIE = (navigator.userAgent.toLowerCase().indexOf('msie') || navigator.userAgent.toLowerCase().indexOf('trident'));if (typeof selectElemOptions_win1 != "undefined")
 {
 for (var i = 0; i < selectElemOptions_win1.length; i++)
 {
 var selectElem = document.forms['win1'].elements[selectElemOptions_win1[i][0]]; if (selectElem == null)
 continue; if (selectElem.options != null)
 var curLen = selectElem.options.length; else
 var curLen = 0; var options = optionsArray_win1[selectElemOptions_win1[i][1]];     var selected = selectElemOptions_win1[i][2]; var erroraccess = selectElemOptions_win1[i][3]; if (typeof options == "undefined" || options==null || selected == null)
