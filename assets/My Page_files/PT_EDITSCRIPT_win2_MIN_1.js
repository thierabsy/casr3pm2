...
var oErr_win2 = null;function PSwarning_win2(msg)
{
msg = PSmessageSubst_win2(msg, PSwarning_win2.arguments, 1);if (isFModeLayout()) 
 psConfirmFluid("Warning", msg);else
 psAlert(msg, "Warning");}

function PSdeferWarning_win2(msg)
{
sDefMsg_win2 = PSmessageSubst_win2(msg, PSdeferWarning_win2.arguments, 1);bDefWarning_win2 = true;}

function PSerror_win2(obj, msg)
{
if (bReset_win2)
{
 resetChange(obj); bReset_win2 = false;}
else
{
 obj.PSsaveclass = obj.className; obj.className = "PSERROR";}
msg = PSmessageSubst_win2(msg, PSerror_win2.arguments, 2);if (isFModeLayout()) 
 psConfirmFluid("Error", msg);else
 psAlert(msg, "Error");oErr_win2=obj;}

function PSdeferError_win2(obj, msg)
{
sDefMsg_win2 = PSmessageSubst_win2(msg, PSdeferError_win2.arguments, 2);oDefErr_win2=obj;bDefWarning_win2 = false; }

function PSshowDeferredMsg_win2()
{
if (sDefMsg_win2=="")return;if (bDefWarning_win2)
 PSwarning_win2(sDefMsg_win2);else
 PSerror_win2(oDefErr_win2, sDefMsg_win2);sDefMsg_win2 = "";oDefErr_win2 = null; }

function PSclearError_win2(obj)
{
if (obj == oDefErr_win2)
{
 sDefMsg_win2 = "";  oDefErr_win2 = null; }
}

function PSmessageSubst_win2(msg, parms, startparm)
{
...
function FindString_win2(obj)
{
var s = prompt("Enter search string:","");if (s == null || s == "")
 return false;obj.value = s;return true;}

function DeleteCheck_win2(form,name)
{


var deleteAction = 'oParentWin.aAction_win2(oParentWin.document.win2' + ',"' + name + '")';psConfirm2("Delete Confirmation", "Delete current/selected rows from this page?  The delete will occur when the transaction is saved.", "OKCancel", " ", deleteAction);}

function DeleteCheck2_win2()
{
if (arguments.length == 0) 
 return confirm("Delete current/selected rows from this page?  The delete will occur when the transaction is saved.");else 
 {
 if (bAccessibility_win2) 
 var deleteAction = 'submitAction_win2(document.win2' + ',"' + arguments[0] + '")'; else 
 var deleteAction = 'oParentWin.aAction_win2(oParentWin.document.win2' + ',"' + arguments[0] + '")';     if (isFModeLayout())
...
var oChange_win2 = null;var oDefErr_win2 = null;var sDefMsg_win2 = "";var bDefWarn_win2; var oKillFocus_win2 = null;var oTargetFocus_win2 = null;var bReset_win2 = false;function initVars_win2()
{


oChange_win2 = null;oDefErr_win2 = null;sDefMsg_win2 = "";bDefWarn_win2 = false; oKillFocus_win2 = null;oTargetFocus_win2 = null;bReset_win2 = false;nLastKey_win2 = 0;}
function moveFocus_win2(killobj)
{
if (typeof popupObj_win2 != "undefined" && popupObj_win2 && popupObj_win2.isShown) 
 ptCommonObj2.tryFocus0(popupObj_win2.popupFocus);if (oErr_win2!=null)
{
 oKillFocus_win2 = killobj; oTargetFocus_win2 = oErr_win2; oErr_win2.focus(); oErr_win2 = null;}
}

function doFocus_win2(obj,bTabonly,bDef)
{
if (obj == null) return;if (typeof gridRowSelRgbColor_win2 != "undefined") {
 var gridRowID = getGridRowID(obj);  if (gridRowID != null && gridRowID.length > 0 )
 HighLightTR(gridRowSelRgbColor_win2,'',gridRowID);}
...
if (window.focusHook)
 focusHook(obj);if (obj==oTargetFocus_win2)
{
 oTargetFocus_win2 = null; oKillFocus_win2 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2(obj);if(!bTabonly || getLastKey_win2() == "\t".charCodeAt(0))
{
 if(oChange_win2!=null && oChange_win2!=obj)
 {
 oChange_win2.form.ICFocus.value=obj.id; submitAction_win2(oChange_win2.form,oChange_win2.id); oChange_win2 = null; }
 else if(bDef && oDefErr_win2!=null && oDefErr_win2!=obj)
 PSshowDeferredMsg_win2();}
moveFocus_win2(obj);}

function doFocusMac_win2(obj,bTabonly)
{
if (obj==oTargetFocus_win2)
{
 oTartgetFocus_win2 = null; oKillFocus_win2 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2();document.win2.ICFocus.value = obj.id;if(oDefErr_win2!=null && oDefErr_win2!=obj)
 PSshowDeferredMsg_win2();moveFocus_win2(obj);}

function doReqField_win2(obj, bserver, bnumeric)
{

if (oKillFocus_win2==obj)
...
{
 if (bserver)
 oChange_win2=obj; else
 PSdeferError(obj, "Field is required."); }
}

function addchg_win2(obj,id) {
...
if (typeof obj == "undefined" && typeof id == "undefined") return;if (obj) id = obj.id; else obj = document.getElementById(id);if (!obj || id.length == 0) return;if (isFModeLayout() && obj.type == "select-one")
 ...
 if (typeof document.chgFldArr_win2 != "undefined" && document.chgFldArr_win2 != "undefined")
 {
 var bFound = false; for (var i = 0; i < document.chgFldArr_win2.length; i++) {
 if (document.chgFldArr_win2[i] == id) {
 bFound = true; continue; }
 }
 if (!bFound) 
 document.chgFldArr_win2.push(id); }
 } catch (e) {}
}

function doEdits_win2(obj,sType,bHist,bEffdtSub,bDate,bYN,bUCase,bImmed, re)
{

gFocusObj=obj;if(sDefMsg_win2!="")
{
 PSshowDeferredMsg_win2(); return false;}


if(oChange_win2 != null)
{
 submitAction_win2(obj.form,obj.id); return true;}
...
var bErr = false; if(sType!='') bErr = checkType_win2(obj, sType, re);if(!bErr && bHist=='Y') bErr = historyUpdated_win2(obj);if(!bErr && bEffdtSub=='Y') bErr =subscrollUpdated_win2(obj);if(!bErr && bDate=='Y') bErr = isReasonableDate_win2(obj);if(!bErr && bYN=='Y') bErr = isYN_win2(obj);if (bErr && bImmed=='Y') PSshowDeferredMsg_win2();return true;}
...
function historyUpdated_win2(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win2(obj, "Cannot change current or history records unless in Correction mode.");bReset_win2 = true;return true;}

function subscrollUpdated_win2(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win2(obj, "Cannot change key field with effective dated subordinate data unless in Correction mode.");bReset_win2 = true;return true;}



function isReasonableDate_win2(obj)
{
if(obj.type == "select-one") obj = obj.options[obj.selectedIndex];var dateval = new Date(obj.value);var now = new Date();var diff = new Date(Math.abs(now.getTime() - dateval.getTime()));if (diff.getMonth > 0)
 ...
 PSdeferWarning_win2("Warning -- date out of range.");return false;}


function isYN_win2(obj)
{
 ...
 val = obj.value;if (val != 'Y' && val != 'N')
{
 ...
 PSdeferError_win2(obj, "Value must either be Y for Yes or N for No."); return true;}
return false;}


function isNumOnly_win2(obj)
{
var val = obj.value;if (val == '') return false;if (val.search(/^ *\d* *$/) != 0)
{
 
 PSdeferError_win2(obj, "Numeric Only field format error.  Please reenter."); return true;}
return false;}

function isNumeric_win2(obj,fmt,re)
{
var val = obj.value;if (val == '') return false;if (val.search(re) != 0)
{
 
 PSdeferError_win2(obj, "Number field format error. Please re-enter using the proper format.  %1", fmt); return true;}
return false;}

function isTime_win2(obj,fmt)
{
var val = obj.value;if (val == '') return false;if (!checkTime(val,fmt))
{
 
 PSdeferError_win2(obj, "Time field format error.  Please re-enter using the proper format."); return true;}
return false;}

function isDateTime_win2(obj,fmt)
{
var val = obj.value;if (val == '') return false;var newval = checkDateTime(val,fmt);if (newval == "")
{
 
 PSdeferError_win2(obj, "Datetime field format error.  Please reenter using the proper format."); return true;}
obj.value = newval;return false;}

function isDate_win2(obj,fmt)
{
var val = obj.value;if (val == '') return false;var dt = getDate(val,fmt,szCalendarType);if (dt==null)
{
 PSdeferError_win2(obj, "The system does not understand the date you entered.");  return true;}
obj.value = pt_formatDate(dt, fmt, szCalendarType);return false;}

function checkType_win2(obj,sType,re)
{
var cType = sType.substring(0, 1);var sFmt = sType.substring(1);switch(cType)
{
case 'N': return isNumOnly_win2(obj);case 'S': return isNumeric_win2(obj,sFmt,re);case 'D': return isDate_win2(obj,sFmt);case 'T': return isTime_win2(obj,sFmt);case 'X': return isDateTime_win2(obj,sFmt);}
return false;}
...
function setSelectElemOptions_win2()
{

var bIE = (navigator.userAgent.toLowerCase().indexOf('msie') || navigator.userAgent.toLowerCase().indexOf('trident'));if (typeof selectElemOptions_win2 != "undefined")
 {
 for (var i = 0; i < selectElemOptions_win2.length; i++)
 {
 var selectElem = document.forms['win2'].elements[selectElemOptions_win2[i][0]]; if (selectElem == null)
 continue; if (selectElem.options != null)
 var curLen = selectElem.options.length; else
 var curLen = 0; var options = optionsArray_win2[selectElemOptions_win2[i][1]];     var selected = selectElemOptions_win2[i][2]; var erroraccess = selectElemOptions_win2[i][3]; if (typeof options == "undefined" || options==null || selected == null)
