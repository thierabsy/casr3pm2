...
ShowPopup:function(evt,winname) 
{
 ...
 this.focusElem=null; HelppopupObj_win3.SetHeader(winname); HelppopupObj_win3.SetShadow(winname); var HelppopContainer = document.getElementById("HelppopupContainer_"+winname); var HelppopFrame = document.getElementById("HelpdivpopupFrame_"+winname); HelppopFrame.focus(); ptEvent.add(HelppopContainer,"keypress",function(evt){HelppopupObj_win3.HandleEscapeKey(evt,winname)}); cancelBubble(evt);},
