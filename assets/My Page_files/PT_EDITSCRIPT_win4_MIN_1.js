...
var oErr_win4 = null;function PSwarning_win4(msg)
{
msg = PSmessageSubst_win4(msg, PSwarning_win4.arguments, 1);if (isFModeLayout()) 
 psConfirmFluid("Warning", msg);else
 psAlert(msg, "Warning");}

function PSdeferWarning_win4(msg)
{
sDefMsg_win4 = PSmessageSubst_win4(msg, PSdeferWarning_win4.arguments, 1);bDefWarning_win4 = true;}

function PSerror_win4(obj, msg)
{
if (bReset_win4)
{
 resetChange(obj); bReset_win4 = false;}
else
{
 obj.PSsaveclass = obj.className; obj.className = "PSERROR";}
msg = PSmessageSubst_win4(msg, PSerror_win4.arguments, 2);if (isFModeLayout()) 
 psConfirmFluid("Error", msg);else
 psAlert(msg, "Error");oErr_win4=obj;}

function PSdeferError_win4(obj, msg)
{
sDefMsg_win4 = PSmessageSubst_win4(msg, PSdeferError_win4.arguments, 2);oDefErr_win4=obj;bDefWarning_win4 = false; }

function PSshowDeferredMsg_win4()
{
if (sDefMsg_win4=="")return;if (bDefWarning_win4)
 PSwarning_win4(sDefMsg_win4);else
 PSerror_win4(oDefErr_win4, sDefMsg_win4);sDefMsg_win4 = "";oDefErr_win4 = null; }

function PSclearError_win4(obj)
{
if (obj == oDefErr_win4)
{
 sDefMsg_win4 = "";  oDefErr_win4 = null; }
}

function PSmessageSubst_win4(msg, parms, startparm)
{
...
function FindString_win4(obj)
{
var s = prompt("Enter search string:","");if (s == null || s == "")
 return false;obj.value = s;return true;}

function DeleteCheck_win4(form,name)
{


var deleteAction = 'oParentWin.aAction_win4(oParentWin.document.win4' + ',"' + name + '")';psConfirm2("Delete Confirmation", "Delete current/selected rows from this page?  The delete will occur when the transaction is saved.", "OKCancel", " ", deleteAction);}

function DeleteCheck2_win4()
{
if (arguments.length == 0) 
 return confirm("Delete current/selected rows from this page?  The delete will occur when the transaction is saved.");else 
 {
 if (bAccessibility_win4) 
 var deleteAction = 'submitAction_win4(document.win4' + ',"' + arguments[0] + '")'; else 
 var deleteAction = 'oParentWin.aAction_win4(oParentWin.document.win4' + ',"' + arguments[0] + '")';     if (isFModeLayout())
...
var oChange_win4 = null;var oDefErr_win4 = null;var sDefMsg_win4 = "";var bDefWarn_win4; var oKillFocus_win4 = null;var oTargetFocus_win4 = null;var bReset_win4 = false;function initVars_win4()
{


oChange_win4 = null;oDefErr_win4 = null;sDefMsg_win4 = "";bDefWarn_win4 = false; oKillFocus_win4 = null;oTargetFocus_win4 = null;bReset_win4 = false;nLastKey_win4 = 0;}
function moveFocus_win4(killobj)
{
if (typeof popupObj_win4 != "undefined" && popupObj_win4 && popupObj_win4.isShown) 
 ptCommonObj2.tryFocus0(popupObj_win4.popupFocus);if (oErr_win4!=null)
{
 oKillFocus_win4 = killobj; oTargetFocus_win4 = oErr_win4; oErr_win4.focus(); oErr_win4 = null;}
}

function doFocus_win4(obj,bTabonly,bDef)
{
if (obj == null) return;if (typeof gridRowSelRgbColor_win4 != "undefined") {
 var gridRowID = getGridRowID(obj);  if (gridRowID != null && gridRowID.length > 0 )
 HighLightTR(gridRowSelRgbColor_win4,'',gridRowID);}
...
if (window.focusHook)
 focusHook(obj);if (obj==oTargetFocus_win4)
{
 oTargetFocus_win4 = null; oKillFocus_win4 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2(obj);if(!bTabonly || getLastKey_win4() == "\t".charCodeAt(0))
{
 if(oChange_win4!=null && oChange_win4!=obj)
 {
 oChange_win4.form.ICFocus.value=obj.id; submitAction_win4(oChange_win4.form,oChange_win4.id); oChange_win4 = null; }
 else if(bDef && oDefErr_win4!=null && oDefErr_win4!=obj)
 PSshowDeferredMsg_win4();}
moveFocus_win4(obj);}

function doFocusMac_win4(obj,bTabonly)
{
if (obj==oTargetFocus_win4)
{
 oTartgetFocus_win4 = null; oKillFocus_win4 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2();document.win4.ICFocus.value = obj.id;if(oDefErr_win4!=null && oDefErr_win4!=obj)
 PSshowDeferredMsg_win4();moveFocus_win4(obj);}

function doReqField_win4(obj, bserver, bnumeric)
{

if (oKillFocus_win4==obj)
...
{
 if (bserver)
 oChange_win4=obj; else
 PSdeferError(obj, "Field is required."); }
}

function addchg_win4(obj,id) {
...
if (typeof obj == "undefined" && typeof id == "undefined") return;if (obj) id = obj.id; else obj = document.getElementById(id);if (!obj || id.length == 0) return;if (isFModeLayout() && obj.type == "select-one")
 ...
 if (typeof document.chgFldArr_win4 != "undefined" && document.chgFldArr_win4 != "undefined")
 {
 var bFound = false; for (var i = 0; i < document.chgFldArr_win4.length; i++) {
 if (document.chgFldArr_win4[i] == id) {
 bFound = true; continue; }
 }
 if (!bFound) 
 document.chgFldArr_win4.push(id); }
 } catch (e) {}
}

function doEdits_win4(obj,sType,bHist,bEffdtSub,bDate,bYN,bUCase,bImmed, re)
{

gFocusObj=obj;if(sDefMsg_win4!="")
{
 PSshowDeferredMsg_win4(); return false;}


if(oChange_win4 != null)
{
 submitAction_win4(obj.form,obj.id); return true;}
...
var bErr = false; if(sType!='') bErr = checkType_win4(obj, sType, re);if(!bErr && bHist=='Y') bErr = historyUpdated_win4(obj);if(!bErr && bEffdtSub=='Y') bErr =subscrollUpdated_win4(obj);if(!bErr && bDate=='Y') bErr = isReasonableDate_win4(obj);if(!bErr && bYN=='Y') bErr = isYN_win4(obj);if (bErr && bImmed=='Y') PSshowDeferredMsg_win4();return true;}
...
function historyUpdated_win4(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win4(obj, "Cannot change current or history records unless in Correction mode.");bReset_win4 = true;return true;}

function subscrollUpdated_win4(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win4(obj, "Cannot change key field with effective dated subordinate data unless in Correction mode.");bReset_win4 = true;return true;}



function isReasonableDate_win4(obj)
{
if(obj.type == "select-one") obj = obj.options[obj.selectedIndex];var dateval = new Date(obj.value);var now = new Date();var diff = new Date(Math.abs(now.getTime() - dateval.getTime()));if (diff.getMonth > 0)
 ...
 PSdeferWarning_win4("Warning -- date out of range.");return false;}


function isYN_win4(obj)
{
 ...
 val = obj.value;if (val != 'Y' && val != 'N')
{
 ...
 PSdeferError_win4(obj, "Value must either be Y for Yes or N for No."); return true;}
return false;}


function isNumOnly_win4(obj)
{
var val = obj.value;if (val == '') return false;if (val.search(/^ *\d* *$/) != 0)
{
 
 PSdeferError_win4(obj, "Numeric Only field format error.  Please reenter."); return true;}
return false;}

function isNumeric_win4(obj,fmt,re)
{
var val = obj.value;if (val == '') return false;if (val.search(re) != 0)
{
 
 PSdeferError_win4(obj, "Number field format error. Please re-enter using the proper format.  %1", fmt); return true;}
return false;}

function isTime_win4(obj,fmt)
{
var val = obj.value;if (val == '') return false;if (!checkTime(val,fmt))
{
 
 PSdeferError_win4(obj, "Time field format error.  Please re-enter using the proper format."); return true;}
return false;}

function isDateTime_win4(obj,fmt)
{
var val = obj.value;if (val == '') return false;var newval = checkDateTime(val,fmt);if (newval == "")
{
 
 PSdeferError_win4(obj, "Datetime field format error.  Please reenter using the proper format."); return true;}
obj.value = newval;return false;}

function isDate_win4(obj,fmt)
{
var val = obj.value;if (val == '') return false;var dt = getDate(val,fmt,szCalendarType);if (dt==null)
{
 PSdeferError_win4(obj, "The system does not understand the date you entered.");  return true;}
obj.value = pt_formatDate(dt, fmt, szCalendarType);return false;}

function checkType_win4(obj,sType,re)
{
var cType = sType.substring(0, 1);var sFmt = sType.substring(1);switch(cType)
{
case 'N': return isNumOnly_win4(obj);case 'S': return isNumeric_win4(obj,sFmt,re);case 'D': return isDate_win4(obj,sFmt);case 'T': return isTime_win4(obj,sFmt);case 'X': return isDateTime_win4(obj,sFmt);}
return false;}
...
function setSelectElemOptions_win4()
{

var bIE = (navigator.userAgent.toLowerCase().indexOf('msie') || navigator.userAgent.toLowerCase().indexOf('trident'));if (typeof selectElemOptions_win4 != "undefined")
 {
 for (var i = 0; i < selectElemOptions_win4.length; i++)
 {
 var selectElem = document.forms['win4'].elements[selectElemOptions_win4[i][0]]; if (selectElem == null)
 continue; if (selectElem.options != null)
 var curLen = selectElem.options.length; else
 var curLen = 0; var options = optionsArray_win4[selectElemOptions_win4[i][1]];     var selected = selectElemOptions_win4[i][2]; var erroraccess = selectElemOptions_win4[i][3]; if (typeof options == "undefined" || options==null || selected == null)
