...
{
var waitobj = document.getElementById("WAIT_win3");var saveobj = document.getElementById("SAVED_win3");var saveWaitObj = document.getElementById("saveWait_win3");updateWindowTitleFromFakeBC(); if (opt == 0)
{
...
if (opt == 2)
{
 showhide(waitobj, false); setSaveText_win3('Saved'); if (saveWaitObj)
 saveWaitObj.style.display = "none"; bTimer = setTimeout("processing_win3(0)",waittime);  if ((typeof top.ptaiAguide=='object') && top.ptaiAguide.ptaiItemId!=null && top.ptaiAguide.ptaiItemId)
 {AgPostMessage();}
}
}
...
var nLastKey_win3 = 0;var oLastKeyEvent = null;var gKeyDownTarget = null;function doKeyDown_win3(evt)
{
oLastKeyEvent = evt;var target = getEventTarget(evt);gKeyDownTarget = target;if (!isFModeLayout() && !PT_handleTabKeyForModalDialog(evt))
 ...
 return findHandler("doKeyDown_" + target.form.name, evt);nLastKey_win3 = getKeyCode(evt);var bKeyUp = target && target.getAttribute('onkeyup') != null;if (isFModeLayout() && nLastKey_win3 == 13 && bKeyUp)
 evt.preventDefault();if (nLastKey_win3 != "\t".charCodeAt(0)) {

if (isGridNav(evt))
 ptGridObj_win3.doArrowNavGrid(evt);if (isTypeAheadEl(evt))
 ptTAObj_win3.KeyUpDown(evt);if(browserInfoObj2.isSafari && nLastKey_win3 == 27){
...
if (keyChar == "\r" && (!(isButton(target) || isRowAct(target)) || !isFModeLayout()) || key == 27)
 ...
 if (key == 27)
 {
 if (typeof (bDoModal_win3) != "undefined" && bDoModal_win3 && modalID != null) 
 doUpdateParent(document.win3, '#ICCancel');  else if (isFModeLayout() && bInModal)
 submitAction_win3(document.win3, '#ICCancel'); return; } 
...
{ 
 ...
 submitAction_win3(document.win3, event.srcElement.id); else 
 submitAction_win3(document.win3, evt.target.id);}else
{
...
window.doKeyPress_win3 = function (evt)
 ...
 addchg_win3(target); if (isFModeLayout() && target && (target.getAttribute('onkeyup') != null
 || target.getAttribute('onkeydown') != null))
 return; if (target && target.form && target.form.name != "win3")
 ...
 submitAction_win3(document.win3, "#KEY" + code); return false; }
}
...
{
 var currentNode = document.getElementById(document.win3.name+"div"+fldname); if(currentNode)
 {
 ...
 var element ; for (var i = 0; i < document.win3.elements.length; i++)
 {
 element = document.win3.elements[i]; if( element && element.tabIndex > 0 && element.type != "hidden" ) 
 { 
 try{
 tryFocus0New(element);  break;  }
 catch(e){
...
function tryFocus0New(obj)
{
 ...
 ptGridObj_win3.doScrollOnFocus(gn, obj); return false; }
return true;}
...
{
var obj;if ((typeof bAccessibility_win3 != 'undefined') && (bAccessibility_win3)) 
 {
 obj = document.getElementById("MessageTitle_win3"); if (obj)
 return tryFocus(obj); }
...
function UpdateBreadCrumbs() {
 ...
 bcUpdater.updateBreadCrumbs(document.win3); bcUpdater.removeRemoteData();  backNavigation.setCookie(); if (!isFModeLayout()) {
 updClassicHistory()
 }
...
function aAction0_win3(form, name, params, bAjax, bPrompt)
{
if (isFModeLayout() && isPopupRequest(form, name)) return;if (typeof bSearchDialog_win3 != 'undefined' && !bDoModal_win3 && bSearchDialog_win3 && form.ICAction.value.indexOf("\x1b") >=0) 
 {
...
if (typeof ptGridObj_win3 != 'undefined' && ptGridObj_win3)
 ptGridObj_win3.saveScrollPos();form.ICResubmit.value=nResubmit;form.ICAction.value=name;form.ICXPos.value = ptCommonObj2.getScrollX();form.ICYPos.value = ptCommonObj2.getScrollY();bcUpdater.getAdvSrchLblFrmCriteria(name, form);var waitingObjList = null;if (loader != null && loader.GetWaitingICAction() != "") 
 ...
 loader=new net2.ContentLoader(postUrl_win3,form,name,null,null,null,null,null,bAjax, bPrompt);else
 loader=new net2.ContentLoader(postUrl_win3,form,name,null,null,null,params,null,bAjax, bPrompt);if (waitingObjList != null)
...
{
 aAction_win3(form, name, params); var searchObj = document.getElementById('PT_SEARCH'); addClass(searchObj, 'side'); addClose(searchObj); SetSearchStatus(obj, form);}
...
function doModalOnLoad_win3(bStartUp, bFileDetach, bNoParent) {
 ...
 && typeof winParent.document.win3 != 'undefined')
...
function doModalMFormSubmit_win3(form, name) {
 ...
 winParent.bCleanHtml = false; winParent.loader = null; winParent.document.win3.ICStateNum.value = document.win3.ICStateNum.value; winParent.aAction_win3(winParent.document.win3, '#ICCancel'); window.winParent.modWin = null; closeModal(window.modalID); return; }
...
var bEventContinue= true;var tabSelect;var newTab = null;var currentTarget = event.currentTarget || event.srcElement;if (currentTarget.tagName == 'LI') 
 ...
 {
 document.win3.ICFocus.value = (tabSelect.firstElementChild || tabSelect.firstChild).id; currentTarget.onclick(); }
 break;  case 39: 
 case 40: 
...
processing_win3(1, 3000);var sFormName = "win3";OpenRCService(url,nOpenMode,nFluidComponent,szServType,strLabel,strFldID,bBulkAction,szParamXML,sFormName);if (nOpenMode == "0")
...
function DisplayNUIRCMenu_win3(FieldName,nLeft,nTop,sMenu) {
 ...
 var mDivObj = document.getElementById('win3' + 'div' + FieldName + '$divpop'); if (!mDivObj)
