...
var deleteAction = 'oParentWin.aAction_win5(oParentWin.document.win5' + ',"' + name + '")';psConfirm2("Delete Confirmation", "Delete current/selected rows from this page?  The delete will occur when the transaction is saved.", "OKCancel", " ", deleteAction);}

function DeleteCheck2_win5()
{
...
{
if (obj == null) return;if (typeof gridRowSelRgbColor_win5 != "undefined") {
...
if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2(obj);if(!bTabonly || getLastKey_win5() == "\t".charCodeAt(0))
{
 if(oChange_win5!=null && oChange_win5!=obj)
 {
 oChange_win5.form.ICFocus.value=obj.id; submitAction_win5(oChange_win5.form,oChange_win5.id); oChange_win5 = null; }
...
var val = obj.value;if (val == '') return false;if (val.search(re) != 0)
{
 ...
 PSdeferError_win5(obj, "Number field format error. Please re-enter using the proper format.  %1", fmt); return true;}
return false;}
